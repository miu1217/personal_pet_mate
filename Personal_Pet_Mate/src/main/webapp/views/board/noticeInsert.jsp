		...
		<div id="insertBo">
			...
			<form action="${contextPath }/pet.insertNo" method="post" onsubmit="return insertChk();" id="goInsert">
				...
				<main>
					<div class="insert">
						<div class="subject">
							<input name="title" id="title" class="insertT" type="text" value="" placeholder="제목을 입력하세요."> <span class="num_byte"> <span id="subject_limit" class="current_num">(0/ 30글자)</span>
							</span>
						</div>

						<div class="content" id="mainContent">
							<textarea type="text" id="content" name="content" rows="1" placeholder="내용을 입력하세요."></textarea>
							<br> <span class="num_byte"> <span id="content_limit" class="current_num">(0/ 2000글자)</span>
							</span>
						</div>
				</main>
				<footer>
