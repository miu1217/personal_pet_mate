		...
		<div id="insertBo">
			...
			<form action="${contextPath }/mate.qnaUpdate" method="post" id="goUpdate" encType="multipart/form-data">
				...
				<main>
					<div class="insert">
						<div class="subject">
							<input name="title" id="title" class="insertT" type="text" value="${q.qnaTitle }"> <span class="num_byte"> <span id="subject_limit" class="current_num">(${q.qnaTitle.length() }/30글자)</span>
							</span>
						</div>
						<div class="filebox">
							<input type="hidden" name="originFileNo" value="${at.fileNo }"> <input type="hidden" name="originFileName" value="${at.changeName }"> <input class="upload-name" value="${at.originName }"> <label for="refile">파일찾기</label> <input type="file" id="refile" name="refile" onchange="loadImg(this,1);">

						</div>
						<div class="content" id="mainContent">
							<textarea id="content" name="content" rows="1">${q.qnaContent }</textarea>
							<br> <span class="num_byte"> <span id="content_limit" class="current_num">(${q.qnaContent.length() }/2000글자)</span>
							</span> <br> <img id="inputImg" src="${contextPath}${at.filePath}${at.changeName}">
