...
/**
 * Servlet implementation class BoardFreeBController
 */
@WebServlet("/pet.freeBoard")
public class BoardFreeBController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardFreeBController() {
        super();
