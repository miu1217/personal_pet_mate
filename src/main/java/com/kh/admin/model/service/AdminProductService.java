...
public class AdminProductService {
	...
	public int insertProdcut(Product p, ArrayList<ProductAttachment> pList) {
		Connection conn = JDBCTemplate.getConnection();
		
		int result = new AdminProductDao().insertProdcut(conn, p);
	...
	//상품 리스트 가져오는 메소드
	public ArrayList<Product> selectListProdcut() {
		Connection conn = JDBCTemplate.getConnection();
