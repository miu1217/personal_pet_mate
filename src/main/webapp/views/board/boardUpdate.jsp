    ...
    <form action="${contextPath }/pet.boardUpdate" method="post" id="goUpdate" encType="multipart/form-data">
      ...
      <main>
        <div class="insert">
          ...
          <div class="filebox">
				<input type="hidden" name="originFileNo" value="${ba.fileNo }">
				<input type="hidden" name="originFileName" value="${ba.changeName }">
				
	              <input class="upload-name"  value="${ba.originName }" >
