...
<body>
	...
	<div align="center" class="paging=area">
			<c:choose>
				...
				<c:otherwise>
					<button onclick="location.href='pet.notice?currentPage=${pb.startPage-10}'">이전</button>
				</c:otherwise>
			</c:choose>


			<c:forEach var="i" begin="${pb.startPage }" end="${pb.endPage }">
				<button onclick="location.href='pet.notice?currentPage=${i}'">${i}</button>
			</c:forEach>
			...
			<c:choose>
				...
				<c:otherwise>
					<button onclick="location.href='pet.notice?currentPage=${pb.startPage+10}'">다음</button>
				</c:otherwise>
			</c:choose>
		</div>
