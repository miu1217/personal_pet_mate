...
<body>
    ...
    <div class="contact-form spad">
        <div class="container">
            ...
            <form action="${contextPath }/pet.update.r" method="post" id="update-area" enctype="multipart/form-data">
            	<input type="hidden" name="pno" value="${r.productNo }">
                ...
                <div class="row">
                    ...
                    <textarea name="reviewContent"placeholder="Review Content">${r.reviewContent }</textarea>
                    </div>
                   	<div class="col-lg-6 col-md-6" >
                   		<input type="hidden" name = "originFileNo" value="${ra.fileNo }">
						<input type="hidden" name = "originFileName" value="${ra.changeName }">
                     ...
                     <div class="form-group"id="file-area">
				      ...
				      <input class="form-control" type="file" id="reUploadFile" name="reUploadFile"  onchange="loadImg(this,1)" >
				    </div>
                    <div class="col-lg-12 text-center">
