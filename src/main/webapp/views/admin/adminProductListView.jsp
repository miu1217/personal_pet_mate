...
<body class="">
    ...
    <div class="wrapper ">
        <div class="sidebar" data-color="white" data-active-color="danger">
            <div class="logo">
                ...
                </a> <a href="${contextPath }" class="simple-text logo-normal"> ADMIN <!-- <div class="logo-image-big">
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    <li><a href="${contextPath}/pet.admin.list.m"> <i class="nc-icon nc-pin-3"></i>
                            <p>User List</p>
                    </a></li>
                    <li><a href="${contextPath}/pet.admin.list.pd?currentPage=1"> <i class="nc-icon nc-tile-56"></i>
                            <p>Prodcut List</p>
                    </a></li>
                </ul>
            </div>
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;" style="font-weight: bold;">Product List</a>
                    </div>
                            ...
                            <c:otherwise>
                                <c:forEach items="${phList }" var="ph">
                                    <div class="thumbnail" style="display: flex;">
                                        ...
                                        <div class="product__item__text" style="margin: 80px 10px 0px 10px;">
                                            No.${ph.productNo } ${ph.productName }<br> price : ${ph.productPrice }
                                        </div>
                                    </div>
                                </c:forEach>
                            </c:otherwise>
                    ...
                    $(function() {
                        ...
                        $(".thumbnail").click(
                                function() {
                                    ...
                                    location.href = "pet.admin.detail.pd?pno="
            ...
            <div class="nav1">
                    ...
                    <div class="text-right">
                        <button class="btn btn-primary btn-sm"  onclick="location.href='${contextPath}/pet.admin.insert.pd'">Product Insert</button>
                    </div>
				    <div align="center" class="pagingbar">
				        <c:choose>
				            <c:when test="${pi.currentPage eq 1}">
				                <a class="page-item disabled"> <span class="page-link">&laquo;</span>
				                </a>
				            </c:when>
				            <c:otherwise>
				                <a class="page-item"> <a class="page-link" href="pet.admin.list.pd?currentPage=${pi.currentPage-1}" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
				                </a>
				                </a>
				            </c:otherwise>
				        </c:choose>
				        <c:forEach var="i" begin="${pi.startPage}" end="${pi.endPage }">
				            <a class="page-item ${pi.currentPage eq i ? 'active' : ''}"> <a class="page-link" href="pet.admin.list.pd?currentPage=${i}">${i}</a>
				            </a>
				        </c:forEach>
				        <c:choose>
				            <c:when test="${pi.currentPage eq pi.maxPage}">
				                <a class="page-item disabled"> <span class="page-link">&raquo;</span>
				                </a>
				            </c:when>
				            <c:otherwise>
				                <div class="page-item">
				                    <a class="page-link" href="pet.admin.list.pd?currentPage=${pi.currentPage+1}" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
				                    </a>
				                </div>
				            </c:otherwise>
				        </c:choose>
    ...
    <script src="${contextPath }resources/assets/AdminCss/js/paper-dashboard.min.js?v=2.0.1" type="text/javascript"></script>
