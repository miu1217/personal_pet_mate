						...
						<form action="${contextPath }/admin_insert.pd" method="post" id="enroll-area" enctype="multipart/form-data">
							<div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>상품명</label> <input type="text" class="form-control" name="productName">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>카테고리</label> <select name="categoryNo">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>상품 가격</label> <input type="number" class="form-control" name="price">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>상품 성분</label> <input type="text" class="form-control" name="ingredient">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>상품 브랜드</label> <input type="text" class="form-control" name="brand">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<a>대표 이미지</a> <img id="titleImg" width="250" height="170">
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<a>상세 이미지</a> <img id="contentImg1" width="150" height="120">
									</div>
								</div>
								<div class="row">
