									...
									<nav aria-label="Page navigation example" class="pagingbar">
										<ul class="pagination">
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="location.href='mate.qna?currentPage=${pi.currentPage-1}&category=${cno }'" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
													</a></li>
												</c:otherwise>
											</c:choose>
											...
											<c:forEach var="i" begin="${pi.startPage}" end="${pi.endPage}">
												<li class="page-item ${pi.currentPage eq i ? 'active' : ''}"><a class="page-link" href="location.href='mate.qna?currentPage=${i}&category=${cno }'">${i}</a></li>
											</c:forEach>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="location.href='mate.qna?currentPage=${pi.currentPage+1}&category=${cno }'" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
													</a></li>
												</c:otherwise>
											</c:choose>
										</ul>
